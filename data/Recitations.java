 ...
 * @author Burak Torman
 */
public class Recitations extends Lectures {
       
    public StringProperty daysTime;
    public StringProperty ta1;
    public StringProperty ta2;
    
    public Recitations(StringProperty initta1,StringProperty initta2,StringProperty initDaysTime, StringProperty initSection, StringProperty initRoom, StringProperty initTime, StringProperty initDays){
