...
public class OHStyle {
    ...
    public static final String CLASS_OH_TABPANE_TABS     = "oh_tabpane_tabs";
    ...
    public static final String CLASS_OH_SITE_CONTAINER = "oh_site_container";    
    public static final String CLASS_OH_SITE = "oh_site";
    public static final String CLASS_OH_BANNER_LABEL = "oh_banner_label";
    public static final String CLASS_OH_BANNERHEADER_LABEL = "oh_bannerheader_label";
    public static final String CLASS_OH_BANNER_CONTAINER = "oh_banner_container";
    public static final String CLASS_OH_BANNER_LABELS = "oh_banner_labels";
    public static final String CLASS_OH_BANNER_COMBOBOX = "oh_banner_combobox";
    public static final String CLASS_OH_BANNER_COMBO = "oh_banner_combo";
    public static final String CLASS_OH_SITE_LABEL = "oh_site_label";
    public static final String CLASS_OH_STYLEBUTTON = "oh_stylebutton";
    public static final String CLASS_OH_SITE_INSTRUCTOR_BOX = "oh_site_instructor_box";
    public static final String CLASS_OH_SCHEDULE_CONTAINER = "oh_schedule_container";
    public static final String CLASS_OH_TEXTAREA = "oh_textarea";
    public static final String CLASS_OH_SYLLABUS_CONTAINER = "oh_syllabus_container";
    ...
    public static final String CLASS_OH_TITLEFIELD = "oh_titlefield";
    public static final String CLASS_OH_PAGE = "oh_page";
