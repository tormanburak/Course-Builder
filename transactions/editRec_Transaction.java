 ...
 * @author Burak Torman
 */
public class editRec_Transaction implements jTPS_Transaction {
      OfficeHoursApp app;
    Recitations lec;
    ...
    public editRec_Transaction(Recitations initLec,OfficeHoursData initdata, String initsec,String initroom,String initdays,String initta1,String initta2){
        lec = initLec;
